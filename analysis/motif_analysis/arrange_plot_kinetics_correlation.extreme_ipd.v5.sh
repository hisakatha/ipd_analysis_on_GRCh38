...
write_include_for_motif () {
    original_pdf="$1/plot_kinetics_correlation.subset2_3sample.pdf"
    cropped_pdf="cropped_kinetics_correlation.subset2_3sample.$1.pdf"
...
TEX="arrange_plot_kinetics_correlation.extreme_ipd.v5.tex"
echo "" > $TEX
write_header >> $TEX
# High IPD motifs
